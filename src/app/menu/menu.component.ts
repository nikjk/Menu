...
export class MenuComponent {
  menu: MenuItem[] = [
    ...
    { name: 'Pepperoni Pizza', category: 'Pizza', price: 18.99 },
    { name: 'Vegetarian Pizza', category: 'Pizza', price: 17.99 },
    { name: 'Hawaiian Pizza', category: 'Pizza', price: 15.99 },
    { name: 'Meat Lovers Pizza', category: 'Pizza', price: 19.99 },
    { name: 'BBQ Chicken Pizza', category: 'Pizza', price: 18.99 },
    { name: 'Buffalo Chicken Pizza', category: 'Pizza', price: 18.99 },
    { name: 'White Pizza', category: 'Pizza', price: 15.99 },
    { name: 'Pesto Pizza', category: 'Pizza', price: 17.99 },
    { name: 'Supreme Pizza', category: 'Pizza', price: 19.99 },
